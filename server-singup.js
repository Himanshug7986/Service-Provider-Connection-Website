...
////////////////////////////////////////////////////fetching cat////////////////////////////////////////////////////////////////////////////
app.get("/fetch-distinct-cat",function(req,resp){
  mysql.query("select distinct cateogory from task",function(err,resultJsonAry){
...
{
    mysql.query("select * from task where cateogory=?",[req.query.cateogory],function(err,resultJsonAry){
            resp.send(resultJsonAry);
    })
})
...
app.get("/fetch-distinct-city",function(req,resp){
  mysql.query("select distinct city from task",function(err,resultJsonAry){
          resp.send(resultJsonAry);
  })
})
...
{
    mysql.query("select * from task where city=?",[req.query.city],function(err,resultJsonAry){
            resp.send(resultJsonAry);
    })
})
///////////////////////////////////////////////////fetch service//////////////////////////////////////////////////////////////////////////

app.get("/fetch-distinct-ser",function(req,resp){
  mysql.query("select distinct service from provider",function(err,resultJsonAry){
          resp.send(resultJsonAry);
  })
})
...
{
    mysql.query("select * from provider where service=?",[req.query.service],function(err,resultJsonAry){
            resp.send(resultJsonAry);
    })
})
//////////////////////////////////////////////job manag//////////////////////////////////////////////////////////////////////////////////
...
app.get("/angular-fetch-all-work",function(req,resp){
  mysql.query("select * from task",function(err,jsonRecordsAry){
          resp.send(jsonRecordsAry);
  })
})
/////////////////////////////////////////////////fetch email////////////////////////////////////////////////////////////////////////////////////
app.get("/fetch-distinct-email",function(req,resp){
  mysql.query("select distinct emailid from task",function(err,resultJsonAry){
          resp.send(resultJsonAry);
  })
})


app.get("/fetch-rec",function(req,resp)
{
    mysql.query("select * from task where emailid=?",[req.query.emailid],function(err,resultJsonAry){
            resp.send(resultJsonAry);
    })
})
///////////////////////////////////////////////////dodelete///////////////////////////////////////////////////////////////////////////////
app.get("/angular-delete",function(req,resp)
{
    ...
    mysql.query("delete from task where rid=?",[rid],function(err,result)
    {
         if(err==null)
         {
